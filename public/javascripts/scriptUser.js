...
window.addEventListener("load",function(){
 ...
 ////order staust
  ...
  // const currencyValue = parseInt(currencyElement.innerText);
  // currencyElement.innerText = currencyValue.toLocaleString("en-IN");
  ...
  function userStateChecker(){
    ...
    console.log('check',isIndianAddress);
    if(isIndianAddress)
    { console.log("if");
      return true
    }
  ...
  function userPincodChecker(){
    ...
    const userAddressPincode = document.getElementById('userAddressPincode').value;
  ...
  function userHouseNoChecker(){
    const userAddressHouseNo = document.getElementById('userAddressHouseNo').value;

    if(userAddressHouseNo.length ==0 ){
      userAddressHouseNo_error.innerHTML = 'House name /building name  is required'
      return false
    }
    if(userAddressHouseNo.length <4){
      userAddressHouseNo_error.innerHTML = 'House name /building name  is invalid'
      return false
    }
  ...
  function userDistrictChecker(){
    const otherNationDistrict = document.getElementById('otherNationDistrict').value;
  ...
  function userAddressRoadChecker(){
    ...
    if(userAddressRoad.length ==0 ){
      userAddressRoad_error.innerHTML = 'road/town/village/nearest place name is required'
      return false
    }
    if(userAddressRoad.length <3){
      userAddressRoad_error.innerHTML = 'invalid road/city/town/village/nearest place name'
      return false
    }
  ...
  function userAddressNearAddressChecker(){
    const userAddressNearAddress = document.getElementById('userAddressNearAddress').value;
  ...
  function validateAddNewAddress(){
    if(!userNameChecker() || !userPhoneChecker()||!userPincodChecker()||!userStateChecker()||!userCityChecker()||
    !userHouseNoChecker()||!userAddressNearAddressChecker()||!userAddressRoadChecker()){
